...
import com.tuya.connector.open.ability.acl.shield.model.request.ShieldUpdatePermissionRequest;
...
public interface ShieldPermissionConnector {
    ...
    Boolean updatePermission(@Path("permission_code") String permissionCode, @Body ShieldUpdatePermissionRequest req);
